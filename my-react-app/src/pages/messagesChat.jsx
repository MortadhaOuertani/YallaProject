...
export default function messagesChat() {
  return (
    <div className="fixed inset-0 flex flex-col h-screen w-screen bg-white dark:bg-gray-900">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        <div className="flex flex-col gap-4">
          ...
          <Message
            message="That's good to hear! I was wondering if you'd be free for a call later today?"
            time="10:32 AM"
            avatarSrc="/placeholder-avatar.jpg"
            avatarFallback="JD"
          />
          <div className="flex justify-end">
            <div className="max-w-[70%] bg-yellow-500 text-white rounded-lg p-4 text-sm">
              <p>
                Sure, I'm available anytime after 2pm. What works best for you?
              </p>
