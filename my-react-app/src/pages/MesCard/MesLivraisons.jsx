      ...
      <div className=" bg-gray-50 border p-2 rounded mt-8 flex flex-col items-center justify-center"> 
        {livraisons.length > 0 ? (
          livraisons.map((livraison) => (
            <div key={livraison.id} className="w-full bg-white rounded-lg shadow-md p-4 mb-4">
              <div className="flex items-start">
                ...
                <div className="flex-grow">
                  <div className="flex justify-between items-start">
                    <div>
                      <h2 className="text-yellow-500 font-semibold text-lg">Receiver: {livraison.receiverName}</h2>
                    ...
                    <span className="text-yellow-500 font-bold text-xl">{livraison.status}</span>
                  </div>
