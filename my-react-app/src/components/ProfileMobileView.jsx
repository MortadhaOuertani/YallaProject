  ...
  return (
    <>
      <div
        ...
        className={`h-screen lg:w-[19rem] w-[19rem] absolute z-[29] pt-16 lg:transition-all lg:duration-500 lg:ease-in-out ${props.openPorfileDropdown ? 'lg:right-0 transform  ' : ' lg:right-[-100%] '
          }`}
      >
